            ...
            <div class="profiles">
                <div class="profileContainer">
                    ...
                    <div className="profileBack">
                        ...
                        <p className="contactLinks">
                            <a href="https://github.com/Akanchha112" target="_blank" rel="noreferrer">
                                <GitHubIcon />
                            </a>
                            <a href="https://www.linkedin.com/in/akanchha-singh-9138bb202/" target="_blank" rel="noreferrer">
                                <LinkedInIcon />
                            </a>
                        </p>
                    </div>
                ...
                <div class="profileContainer">
                    ...
                    <div className="profileBack">
                        ...
                        <p className="contactLinks">
                            <a href="https://github.com/ambs17" target="_blank" rel="noreferrer">
                                <GitHubIcon />
                            </a>
                            <a href="https://www.linkedin.com/in/ambika-bhandari-177833206/" target="_blank" rel="noreferrer">
                                <LinkedInIcon />
                            </a>
                        </p>
                    </div>
                ...
                <div class="profileContainer">
                    ...
                    <div className="profileBack">
                        ...
                        <p className="contactLinks">
                            <a href="https://github.com/Ayush-Thakur-21" target="_blank" rel="noreferrer">
                                <GitHubIcon />
                            </a>
                        </p>
                    </div>
                ...
                <div class="profileContainer">
                    ...
                    <div className="profileBack">
                        ...
                        <p className="contactLinks">
                            <a href="https://github.com/cheshta-dua" target="_blank" rel="noreferrer">
                                <GitHubIcon />
                            </a>
                            <a href="https://www.linkedin.com/in/cheshta-dua" target="_blank" rel="noreferrer">
                                <LinkedInIcon />
                            </a>
                        </p>
                    </div>
